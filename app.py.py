...
print(f"Trying to open: {wordlist_file}")
...
if os.path.exists(file_path):
    ...
    print("❌ File not found! Downloading it now...")
    !wget https://github.com/brannondorsey/naive-hashcat/releases/download/data/rockyou.txt

with open("rockyou.txt", "r", encoding="latin-1") as file:
    passwords = file.readlines()
print(f"✅ Loaded {len(passwords)} passwords successfully!")

!git clone https://github.com/PavanBoggavarapu/non-hashed-password-cracker-.git

!find /content/ -name "app.py"

!cp /content/non-hashed-password-cracker-/app.py /content/non-hashed-password-cracker-/non-hashed-password-cracker-/app.py

# Commented out IPython magic to ensure Python compatibility.
# %cd /content/non-hashed-password-cracker-/

!git config --global user.name "PavanBoggavarapu"
!git config --global user.email "pavan.b905@gmail.com"

!git add .

!apt-get install git-lfs
!git lfs install
!git lfs track "rockyou.txt"
!git add .gitattributes rockyou.txt

!git commit -m "Added dataset rockyou.txt with Git LFS"
